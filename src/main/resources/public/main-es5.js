...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppComponentsPortfolioPortfolioComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function PortfolioComponent_li_30_div_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PortfolioComponent_li_30_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function PortfolioComponent_li_30_Template(rf, ctx) {
      if (rf & 1) {
